...
import sqlite3
from tkinter import Tk, Frame, StringVar, Label, Button, ttk, FLAT, Listbox, END
...
def show_dashboard_screen():
    ...
    def fill_arts_listbox():
        ...
        for arts in artsen:
            listbox_arts.insert(END, f"{arts['naam']} ({arts['specialisme']})")
    ...
    def show_combination():
        """
        Toont de combinatie van de geselecteerde arts en ziekte in een statuslabel.
        """
        ...
        status_label.config(
            text=f"U heeft gekozen voor {selected_arts} voor een behandeling voor {selected_ziekte}."
        )


    Label(dashboard, text="Dashboard patiëntenbeheer", bg="#4E96D2", fg="white", font=("Arial", 14)).grid(row=0, column=0, sticky="w")
    Button(dashboard, text="Uitloggen", fg="white", bg="#1E5593", relief=FLAT, command=logout, padx=10, pady=5).grid(row=0, column=2, padx=5, sticky="e")
    ...
    patientform.columnconfigure(2, weight=1)

    status_label = Label(patientform, text="", bg="#f8d7da", bd=1, fg="#721c24", font=("Arial", 10), padx=8, pady=4, anchor="w")
    status_label.grid(row=0, column=0, columnspan=3, padx=5, pady=(0, 10), sticky="ew")
    status_label.grid_remove()
    ...
    datasource_frame.grid(row=3, column=2, rowspan=8, padx=(20,0), sticky="nsew")

    datasource_frame.columnconfigure(0, weight=1)

    label_datasource = Label(datasource_frame, text="Kies een databron:", fg="white", bg="#4E96D2", font=("Arial", 12))
    ...
    radiobutton_datasource_database = ttk.Radiobutton(radiobutton_datasource_frame, text="Database", variable=selected_datasource, value="database")
    radiobutton_datasource_database.grid(row=0, column=0, padx=5, pady=5, sticky="w")

    radiobutton_datasource_file = ttk.Radiobutton(radiobutton_datasource_frame, text="Bestand", variable=selected_datasource, value="bestand")
    radiobutton_datasource_file.grid(row=0, column=1, padx=5, pady=5, sticky="w")

    radiobutton_datasource_input = ttk.Radiobutton(radiobutton_datasource_frame, text="Tekstveld", variable=selected_datasource, value="tekstveld")
    ...
    radiobutton_datasource_input_arts = ttk.Radiobutton(datasource_input_frame, text="Arts", variable=selected_datasource_input_type, value="arts")
    radiobutton_datasource_input_arts.grid(row=0, column=1, padx=5, sticky="w")

    radiobutton_datasource_input_ziekte = ttk.Radiobutton(datasource_input_frame, text="Ziekte", variable=selected_datasource_input_type, value="ziekte")

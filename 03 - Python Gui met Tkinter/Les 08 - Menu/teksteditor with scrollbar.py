...
from tkinter import Tk, Text, BOTH, END, Menu, filedialog, Scrollbar, RIGHT, Y, messagebox
...
def help_about():
    messagebox.showinfo(
        "Over Tekst Editor",
        "Tekst Editor\n\n"
        "Gemaakt voor Python GUI met Tkinter - Les 8\n\n"
        "Functies:\n"
        "- Nieuw bestand maken\n"
        "- Bestand openen\n"
        "- Bestand opslaan\n"
...
text_editor = Text(root, undo=True, yscrollcommand=scrollbar.set)

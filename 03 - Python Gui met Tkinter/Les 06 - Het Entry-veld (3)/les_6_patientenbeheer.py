...
def show_dashboard_screen():
    ...
    listbox_frame = Frame(patientform, bg="#4E96D2")
    listbox_frame.grid(row=3, column=2, rowspan=8, padx=(20,0), sticky="nsew")
    ...
    listbox_arts = Listbox(listbox_frame, selectmode="single", exportselection=False, bg="white", fg="black", font=("Arial", 10), height=14)
    ...
    listbox_ziekte = Listbox(listbox_frame, selectmode="single", exportselection=False, bg="white", fg="black", font=("Arial", 10), height=14)
